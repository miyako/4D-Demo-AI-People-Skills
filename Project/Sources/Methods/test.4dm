...
Case of 
	...
	: (False)
		$p.modelsToRemove:={values: ["@-turbo"; "@-preview"; "@-vl-@"; "@-latest"]}
	...
	: (True)
		...
		$p.modelsToRemove:={values: ["Llama-3.3-70B-Instruct-@"; "Qwen3@"; "Phi-4-2"; "Phi-4-3"; "Phi-4-4"; "Phi-4-5"; "Phi-4-6"; "Phi-4-7"; "Phi-3@"; \
			"@vision@"; "@multimodal@"; "mistral-@"; "o1-@"; "o3-@"; "o4-@"; "sora@"; "jais-@"; "model-router@"; "Stable-@"; "grok-@"; "Ministral-@"; "MAI-@"; "FLUX@"; "embed-@"; "computer-@"; "curie"; "codex-@"; "Codestral-@"; "code-@"; \
